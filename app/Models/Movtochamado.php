...
class Movtochamado extends Model
{
    ...
    public function getUltimoMovto(int $chamado_id): ?object
    {
    ...
    public function getUltimoChamado(int $chamado_id): ?object
    {
    ...
    public function atendimentoChamado(array $unidades, int $instituicao = 0): object
    {
        if (!$instituicao) {
            ...
            $chamados = DB::table('movtoChamados as m')
                ->join('users as u', 'u.id', 'm.user_id')
                ->join('unidades as un', 'un.id', 'm.unidade_id')
                ->select('m.chamado_id', 'm.status', 'm.descricao',
                    'm.created_at', 'm.titulo', 'u.name', 'm.id', 'm.tecnico',
                    'm.unidade_id')
                ->where('ativo', true)
                ->where('m.status', '<>', FECHADO)
                ->where('un.instituicao_id', '=', $instituicao)
                ->paginate($this->perPage);
    ...
    public function atenderChamado(int $movto_id): object
    {
    ...
    public function updateTecnico(array $dados): bool
    {
    ...
    public function retornoTecnico(Request $req): array
    {
        try {
    ...
    public function reabrirChamado(Request $req): bool
    {
    ...
    public function historicoChamado(int $chamado_id): object
    {
    ...
    public function filtrarAtendimento(array $dados): object
    {
    ...
    public function filtrarMeusChamados(array $dados): object
    {
